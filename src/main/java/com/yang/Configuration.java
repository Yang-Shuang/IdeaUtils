...
public class Configuration {
     ...
     */
    public Configuration(String path, String code_root) throws IOException {
        this.toolDirectory = new File(path);
        ...
        traverse(new File(code_root), sourceRoots, jarFiles, excludedDirs, excludes);
