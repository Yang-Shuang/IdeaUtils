...
public class IntelliJ {
     ...
     */
    public static void generateFrom(Configuration c, String code_root) throws IOException {
        File templatesDirectory = new File(c.toolDirectory, "templates");
        String ipr = Files.toString(new File(templatesDirectory, IDEA_IPR));
        Files.toFile(ipr, new File(code_root ,IDEA_IPR));
        ...
        Files.toFile(iml, new File(code_root ,IDEA_IML));
    }
